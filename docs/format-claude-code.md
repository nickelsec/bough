...
The Codex CLI rollout format is written up [separately](/docs/format/codex).
The two share a pattern worth naming up front: both replay records they have
already written, and both overcount badly if you take the files at face value.
